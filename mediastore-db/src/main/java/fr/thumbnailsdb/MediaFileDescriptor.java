...
//		try {
        ...
        // " bytes from file");
        id = new MediaFileDescriptor(path, size, modifiedTime, null,  null, 0,0,tag);
...
//		}
     ...
     * @param tag
     */
    public MediaFileDescriptor(String path, long size, long mtime,  String md5, String hash,double lon, double lat,String tag) {
        super();
        this.path = path;
