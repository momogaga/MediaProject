...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            // The duplicateFileList of file processing actions:
            process: [
            /*
                {
                    action: 'load',
            ...
            save: function (data, options) {
                ...
                var that = this,
                    ...
                    callback = function (blob) {
                        ...
                        // of the original file in the files duplicateFileList:
        ...
        // the original position of the files duplicateFileList, returns a Promise object:
